...
export class Game {
    ...
    rotateTetramino() {
        this.activeTetramino.rotationIndex = this.activeTetramino.rotationIndex < 3 ? ++this.activeTetramino.rotationIndex : 0;
        ...
        if (!this.checkOutPosition(this.activeTetramino.x, this.activeTetramino.y)) {
            this.activeTetramino.rotationIndex = this.activeTetramino.rotationIndex > 0 ? --this.activeTetramino.rotationIndex : 3;
            this.activeTetramino.block = this.activeTetramino.rotation[this.activeTetramino.rotationIndex];
        }
    }
    ...
    stopMove() {
        ...
        this.calculateScore(this.clearRow());
        this.updatePanels();
    ...
    restartGame() {
        ...
        this.points = [0, 100, 300, 700, 1500];
